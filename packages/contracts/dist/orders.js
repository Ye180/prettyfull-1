import { z } from "zod";
import { FULFILLMENT_STATUSES, ORDER_STATUSES, PAYMENT_STATUSES, TRANSACTION_KINDS, TRANSACTION_STATUSES, } from "./enums.js";
import { addressInputSchema, addressSchema } from "./auth.js";
import { currencySchema, emailSchema, moneySchema, paginationQuerySchema, uuidSchema, } from "./common.js";
// --- Panier ----------------------------------------------------------------
/**
...
export const canTransitionOrder = (from, to) => ORDER_STATUS_TRANSITIONS[from].includes(to);
