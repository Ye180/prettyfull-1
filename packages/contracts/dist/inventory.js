import { z } from "zod";
import { MANUAL_STOCK_REASONS, STOCK_MOVEMENT_DIRECTIONS, STOCK_MOVEMENT_REASONS, STOCK_STATUSES, RESERVATION_STATUSES, } from "./enums.js";
 ...
 */
export const deriveStockStatus = (availableQuantity, lowStockThreshold, allowBackorder = false) => {
    if (availableQuantity <= 0)
        return allowBackorder ? "low_stock" : "out_of_stock";
