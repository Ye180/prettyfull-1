...
export const toMajorUnit = (amount, currency) => amount / 10 ** CURRENCY_EXPONENTS[currency];
/** 15 + "eur" => 1500. Arrondi au plus proche pour absorber les saisies admin. */
export const toMinorUnit = (amount, currency) => Math.round(amount * 10 ** CURRENCY_EXPONENTS[currency]);
export const formatMoney = (amount, currency, locale = "fr-FR") => new Intl.NumberFormat(locale, {
    style: "currency",
