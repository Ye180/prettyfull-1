...
/**
 * Icône étoile partagée (notation des avis).
 *
 * Source unique : `apps/web/src/components/icons/start.icon.tsx` la
 * réexporte pour ne pas casser ses import existants, et `drawer-reviews.tsx`
 * (ici, dans `packages/ui`) s'en sert directement pour son sélecteur de note.
 */
