		...
		<aside className={`w-full max-w-[280px] bg-white space-y-8 pr-6 border-r border-neutral-100 ${className}`}>
			...
			<div className="flex items-center justify-between pb-4 border-b border-neutral-100">
				<div className="flex items-center gap-2">
					...
					<h3 className="text-[1.8rem] font-bold text-black">Filter</h3>
				</div>
				<button
					onClick={onClear}
			...
			<div className="space-y-3">
				<h4 className="text-[1.5rem] font-semibold text-black">Category</h4>
			...
			{/* Size */}
			<div className="space-y-3">
				<h4 className="text-[1.5rem] font-semibold text-black">Size</h4>
				<div className="space-y-2.5">
			...
			{/* Prize (Price) */}
			<div className="space-y-3">
				<h4 className="text-[1.5rem] font-semibold text-black">Prize</h4>
			...
			{/* Color */}
			<div className="space-y-3">
				<h4 className="text-[1.5rem] font-semibold text-black">Color</h4>
				<div className="flex items-center gap-2 flex-wrap">
					...
					<button
						onClick={() => onChange({ ...filters, color: "Green" })}
			...
			{/* Fit */}
			<div className="space-y-3">
				<h4 className="text-[1.5rem] font-semibold text-black">Fit</h4>
				<div className="space-y-2.5">
					{fitOptions.map((fit) => {
			...
			{/* Material */}
			<div className="space-y-3">
				<h4 className="text-[1.5rem] font-semibold text-black">Material</h4>
				<div className="space-y-2.5">
			...
			{/* Availability */}
			<div className="space-y-3">
				<h4 className="text-[1.5rem] font-semibold text-black">Availability</h4>
				<div className="space-y-2.5">
