...
const Banner = () => {
	...
	return (
		<div className="w-full h-full bg-dark rounded-xl flex items-center justify-center bg-[url(/collections/banner-mode.jpg)] bg-cover bg-start bg-no-repeat relative overflow-hidden">
			...
			<h4 className="border md:min-w-100! md:min-h-40! max-md:text-[4rem]! md:text-[7rem]! font-bold static z-20 px-10 py-4 text-white rounded-lg bg-black/30 backdrop-blur-sm uppercase tracking-wider text-center">
				Collection
			</h4>
		</div>
	);
