	...
	return (
		<div className="w-full md:w-[400px] space-y-6">
			...
			<div className="flex gap-3 items-start p-4 rounded-2xl border border-neutral-200">
				...
				<div>
					<p className="text-sm font-semibold text-neutral-900">Warranty</p>
					<p className="text-xs text-neutral-500">
						1 month warranty coverage on all products. {returnPolicy}
					</p>
				</div>
			</div>
					...
					<table className="w-full text-sm border border-collapse border-neutral-200">
						<thead>
							<tr className="bg-neutral-50">
								<th className="p-3 text-left border border-neutral-200">Size</th>
								<th className="p-3 text-left border border-neutral-200">Bust</th>
								<th className="p-3 text-left border border-neutral-200">Length</th>
								<th className="p-3 text-left border border-neutral-200">Sleeve</th>
							</tr>
						</thead>
						<tbody>
							{SIZE_CHART.map((row) => (
