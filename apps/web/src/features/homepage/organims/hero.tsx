	...
	return (
		<div className=" relative h-[80vh] -z-0 w-full overflow-hidden bg-gray-400  ">
			<Link
				...
				className=" flex justify-between items-center  h-[7%]  bg-black w-full absolute z-30 inset-0 text-white gap-4 py-4"
			>
			...
			{/* <div className="h-[15%]  bg-black w-full absolute z-30 inset-0 ">va</div> */}
		</div>
	);
};
