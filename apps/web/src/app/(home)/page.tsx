    ...
    <>
      <div className="  w-full [&>*]:w-full space-y-12 ">
        ...
        <Container maxWidth="100vw" className="w-full py-[10rem] lg:px-40">
          ...
          <div className="grid max-sm:grid-cols-1 grid-cols-3 gap-x-16 overflow-x-auto items-end">
            {Array.from({ length: 3 }).map((_, index) => (
              <Box
                key={index}
                className="bg-black/60 relative  p-4 flex items-end shadow-md h-[40rem] lg:h-[50rem]  mt-4 aspect-auto "
              >
