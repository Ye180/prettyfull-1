...
export const stubAdapter: PaymentAdapter = {
	...
	description:
		"Simule un paiement pour valider le parcours de bout en bout. Indisponible en production.",
	logoUrl: null,
	...
	verifyWebhook: async (request) => {
		...
		return {
			...
			status: (payload.status as WebhookStatus) ?? "success",
...
type WebhookStatus = "success" | "failed" | "cancelled" | "pending";
