import { buildPaginationMeta, } from "@prettyfull/contracts";
/** Traduit une pagination validée en `limit`/`offset` SQL. */
export const toSqlPagination = (query) => ({
    limit: query.limit,
    offset: (query.page - 1) * query.limit,
});
/** Assemble une réponse paginée à partir des lignes et du total compté. */
export const paginate = (data, query, total) => ({
    data,
 ...
 */
export const iso = (value) => value ? value.toISOString() : null;
/** Variante non nullable, pour les colonnes `notNull`. */
export const isoRequired = (value) => value.toISOString();
