...
import { ACTIVATION_STATUSES, BANNER_PLACEMENTS, CART_STATUSES, CONTACT_MESSAGE_STATUSES, CONTENT_STATUSES, CURRENCY_CODES, DISCOUNT_TYPES, FEATURED_KINDS, FULFILLMENT_STATUSES, INTEGRATION_ENVIRONMENTS, ORDER_STATUSES, PAYMENT_STATUSES, PRODUCT_KINDS, RESERVATION_STATUSES, SHIPPING_RATE_KINDS, STOCK_MOVEMENT_DIRECTIONS, STOCK_MOVEMENT_REASONS, TRANSACTION_KINDS, TRANSACTION_STATUSES, USER_KINDS, USER_STATUSES, } from "@prettyfull/contracts";
/**
...
export const stockMovementDirectionEnum = pgEnum("stock_movement_direction", STOCK_MOVEMENT_DIRECTIONS);
...
export const integrationEnvironmentEnum = pgEnum("integration_environment", INTEGRATION_ENVIRONMENTS);
...
export const contactMessageStatusEnum = pgEnum("contact_message_status", CONTACT_MESSAGE_STATUSES);
