...
export const activationStatusEnum = pgEnum(
	"activation_status",
	ACTIVATION_STATUSES,
);
...
export const transactionKindEnum = pgEnum(
	"transaction_kind",
	TRANSACTION_KINDS,
);
...
export const shippingRateKindEnum = pgEnum(
	"shipping_rate_kind",
	SHIPPING_RATE_KINDS,
);
export const bannerPlacementEnum = pgEnum(
	"banner_placement",
	BANNER_PLACEMENTS,
);
