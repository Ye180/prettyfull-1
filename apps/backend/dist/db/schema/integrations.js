...
export const paymentProviders = pgTable(
	...
	(table) => [
		index("payment_providers_enabled_idx").on(table.isEnabled, table.position),
	],
);
...
export const shippingProviders = pgTable(
	...
	(table) => [
		index("shipping_providers_enabled_idx").on(table.isEnabled, table.position),
	],
);
...
export const webhookEvents = pgTable(
	...
	(table) => [
		uniqueIndex("webhook_events_external_unique").on(
			table.providerKey,
			table.externalId,
		),
