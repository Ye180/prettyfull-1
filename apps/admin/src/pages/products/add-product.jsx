					...
					>
						...
						<div className="flex items-center gap-3">
							<button
								...
								onClick={() => router.back()} // Action Annuler
								className="inline-block px-3 py-2 bg-white border border-gray-200 rounded-lg text-Malertserror hover:bg-red-50" // Style Annuler
							>
