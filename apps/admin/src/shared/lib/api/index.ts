...
export const
  ...
  orders: {
    ...
    getAllCustomersWithOrders: '/orders/customer/list',
    create: '/orders',
  ...
  customer: {
    ...
    getById: (customerId: string) => `/customer/${customerId}`,
    create: '/customer',
    cancel: (customerId: string) => `/customer/${customerId}/cancel`,
    updatePaymentStatus: (customerId: string) => `/customer/${customerId}/payment-status`,
    updateOrderStatus: (customerId: string) => `/customer/${customerId}/status`,
