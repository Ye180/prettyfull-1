...
- **Informations** — bouton *Enregistrer* en haut de page.
- **Galerie** — son propre bouton *Enregistrer la galerie*.
...
*Archiver* retire le produit de la boutique sans rien détruire ; les commandes
passées ne bougent pas, et l'opération est réversible.

*Dupliquer* recopie la structure et les images, en **brouillon** et avec un
...
Passez toujours par *Simuler* avant *Importer* : la simulation n'écrit rien et
...
- *Par articles*, le cas d'un retour : cochez les quantités, et laissez
  « Remettre en stock » si les articles reviennent.
- *Montant libre*, pour un geste commercial qui ne correspond à aucun article
  rendu.
...
3. *Tester la connexion* pour vérifier que les clés sont acceptées.
4. *Activer*.
...
**Bannières** — une bannière n'apparaît que si elle est **publiée** *et* dans sa
